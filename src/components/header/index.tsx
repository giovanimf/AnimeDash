...
export function Header({darkMode, toggleDarkMode, toggleSidebar }:darkModeProps){   
    return(
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start rtl:justify-end">
                        ...
                        <a href="#" className="flex ms-2 md:me-24">
                            <ImHipster2 className="h-8 me-3 text-xl text-violet-500"/>
                            <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">AnimeDash</span>
                        </a>
                    </div>
